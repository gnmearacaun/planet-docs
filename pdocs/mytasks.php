...
//        $stmt = $dbh->query("SELECT id FROM `claimed_tasks` WHERE date(`expiry_date`) >= curdate() and `id` in (select `task_id` from claimed_tasks) order by `published_date` desc");
